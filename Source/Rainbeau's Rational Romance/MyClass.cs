...
namespace RationalRomance_Code
{
	...
	public class JobDriver_DoLovinCasual : JobDriver
	{
		...
		protected override IEnumerable<Toil> MakeNewToils()
		{
			...
			Human_Contact_Need contact_need = this.actor.needs.TryGetNeed<Human_Contact_Need>();
			Human_Contact_Need contact_need_partner = pawn.needs.TryGetNeed<Human_Contact_Need>();
