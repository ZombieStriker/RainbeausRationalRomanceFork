# RainbeausRationalRomanceFork
 
 Since Rainbeau Flambe has stopped developing mods for Rimworld, I have decided to update and maintain this project. If you are a modder and would like to fix some bugs or add some more improvments, you can find the sourcecode on github (link below):
...
(1) Adds Orientations to all pawns. All pawns will now have a trait indicating their sexual orientation, either asexual, bisexual, gay or straight. (Don't worry; the mod doesn't "waste" a trait slot on this, as orientation traits are assigned only *after* regular trait assignment is complete.)
...
(4) Improves Romantic Behavior in General. Pawns will no longer make romance attempts if they've been recently rebuffed, and won't target pawns for such attempts who are currently in mental break or with whom they already have a romantic relationship. Pawns will neither initiate nor receive romance attempts if they have a high opinion of their current lover. And pawns who are gay or straight will be more likely to rebuff romance attempts, breakup, reject marriage proposals from pawns who are a gender they are not attracted to. Finally, the impact of the Ugly trait on romantic attraction is lessened for pawns who have that trait themselves. 
...
(UPDATE: I have decided to enable the polyamorous perk by default, setting the chance to 15%. This number is based off a study from 2013 which found that 5% of the general population reported that they were polyamourous, and 10% was added based on my assumption for the percentage of closeted individuals)
